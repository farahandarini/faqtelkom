            ...
            <div class="bottom_nav">
                <div class="right">
                    <ul>
                        ...
                        <li>
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">USER INTERNAL</a>
                                <div class="dropdown-menu">
                                    @foreach ($kategori_2 as $item_2)
                                    <a class="dropdown-item" href="kategori{{ $item_2->id }}" style="text-transform: uppercase;">
                                        {{ $item_2->kategori }}
                                    </a>
                                    @endforeach
                                </div>
                        ...
                        <li>
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">USER ESKTERNAL</a>
                                <div class="dropdown-menu">
                                    @foreach ($kategori_1 as $item_1)
                                    <a class="dropdown-item" href="kategori{{ $item_1->id }}" style="text-transform: uppercase;">
                                        {{ $item_1->kategori }}
                                    </a>
                                    @endforeach
                                </div>
